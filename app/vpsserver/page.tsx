    ...
    <div className="min-h-screen bg-[#FFF5EF] text-[#4C5671]">
      ...
      <div className="bg-[#FFF8F4] py-20 text-center">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl font-bold text-[#001233] mb-6">High-Performance VPS Servers</h1>

          <p className="text-xl text-[#313149] max-w-4xl mx-auto mb-8">
            Experience unparalleled speed and reliability with our virtual private servers, designed for demanding
            workloads and global reach. Deploy in minutes with full root access.
          </p>
        ...
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="grid md:grid-cols-2 xl:grid-cols-3 gap-6">
              ...
              <Card className="relative hover:shadow-lg transition-shadow bg-[#fff]">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-xl text-[#001233]">VPS Basic</CardTitle>
              ...
              <Card className="relative hover:shadow-lg transition-shadow border-[#FD5D07] bg-[#FD5D07]/5">
                ...
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-xl text-[#001233]">VPS Standard</CardTitle>
              ...
              <Card className="relative hover:shadow-lg transition-shadow bg-[#fff]">
                <CardHeader>
                  <div className="flex justify-between items-start">
                    <div>
                      <CardTitle className="text-xl text-[#001233]">VPS Premium</CardTitle>

                      <CardDescription className="text-[#313149]">
                        Optimized for high-traffic and resource-intensive apps
                      </CardDescription>
                    </div>
                  </div>
                </CardHeader>
              ...
              <Card className="relative hover:shadow-lg transition-shadow border-dashed border-2 border-[#4C5671]/50 bg-[#fff]">
                <CardHeader>
                  <div className="text-center">
                    <CardTitle className="text-xl text-[#001233]">VPS Custom</CardTitle>
            ...
            <Card className="mt-8 bg-[#fff]">
              <CardHeader>
                <CardTitle className="text-[#001233]">Why Choose Our VPS Servers?</CardTitle>
