...
export default function DomainSearchPage() {
    ...
    const addToCart = (item: { name: any; price?: string; salePrice?: string; popular?: boolean; available?: boolean; inCart?: boolean; }) => {
        setDomainResults(
            domainResults.map((d) =>
    ...
    const removeFromCart = (item: { name: any; price?: string; salePrice?: string; popular?: boolean; available?: boolean; inCart?: boolean; }) => {
        setDomainResults(
            domainResults.map((d) =>
                d.name === item.name ? { ...d, inCart: false } : d
            )
        );
        setCart(cart.filter((c: { name: string }) => c.name !== item.name));
    };
                    ...
                    >
                        ...
                        <div className="relative flex items-center overflow-hidden">
                            ...
                            <button
                                ...
                                className={`flex items-center rounded-sm mr-3 px-6 py-4 font-semibold transition ${!domain || searchLoading || whoisLoading
                            ...
                            <button
                                ...
                                className={`flex items-center rounded-sm px-6 py-4 font-semibold transition ${!domain || whoisLoading || searchLoading
                                        ? "bg-gray-400 cursor-not-allowed"
                                        : "bg-amber-600 hover:bg-amber-700 text-white"
                                    }`}
                            >
            ...
            <div className="bg-gradient-to-br from-amber-50 to-white">
                <div className="container mx-auto px-6 py-20">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl font-bold mb-4 text-gray-900">Everything you need to get online</h2>
                        <p className="max-w-2xl mx-auto text-lg text-gray-600">Fast, reliable and secure services for your brand.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                        {[
                            ...
                            <div key={i} className="bg-white p-8 rounded-xl border border-gray-200 hover:shadow-lg hover:-translate-y-1 transition">
            ...
            <div className="container mx-auto px-6 py-20">
                <div className="text-center mb-12">
                    ...
                    <p className="max-w-2xl mx-auto text-lg text-gray-600 mt-4">
                        Check ownership details, name servers, and privacy status in seconds.
                    </p>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {[
                        {
                            ...
                            description: "Access registrar, creation, expiration, and status information.",
                        },
                        {
                            icon: <Globe2 className="w-8 h-8 text-white" />,
                            title: "Name Servers",
                            description: "See DNS configuration and pointing details instantly.",
                        },
                        {
