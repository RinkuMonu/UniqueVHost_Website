        ...
        <div className="grid grid-cols-12 gap-6  justify-content-center pb-24">
          ...
          <div className="col-span-12 md:col-span-6">
            <div className="form">
              ...
              <form className="form__content" method="post" action="mailer.php" id="contact-form">
                <div className="form__control">
                  <input type="text" className="input-form" name="name" id="name" placeholder="what is your name?" required />
                  <input type="email" className="input-form" name="email" id="email" placeholder="Email Address" required />
                </div>
                <div className="form__control">
                  <input type="text" className="input-form" name="phone" id="phone" placeholder="Phone Number" required />
                ...
                <div className="flex items-start gap-2 mt-4">
                  <input type="checkbox" name="checkbox" id="checkbox" className="mt-1" />
