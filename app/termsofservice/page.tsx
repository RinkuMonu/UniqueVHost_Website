...
export default function TermsOfServicePage() {
  const serviceLevels: ServiceItem[] = [
    {
  ...
  const billingTerms: ServiceItem[] = [
    {
  ...
  const accountManagement: ServiceItem[] = [
    {
                    ...
                    <CardContent className="p-6">
                      <div className="mb-4 flex justify-center">
                        <div className="rounded-full bg-green-100 p-3">
                          {item.icon && <item.icon className="h-6 w-6 text-green-600" />}
                        </div>
                      </div>
                  ...
                  <div key={index} className="text-center p-4 rounded-lg bg-blue-50/50">
                    <div className="mb-4 flex justify-center">
                      <div className="rounded-full bg-blue-100 p-3">
                        {item.icon && <item.icon className="h-6 w-6 text-blue-600" />}
                      </div>
                    </div>
